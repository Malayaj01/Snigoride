...
import { BadgePercent, CalendarHeart, ShieldCheck, Signature } from 'lucide-react'

const FEATURES = [
  {
    icon: BadgePercent,
    title: 'Ownership with zero down payment',
    description: 'Start your journey to owning an EV without the burden of hefty upfront initial costs.'
  },
  {
    icon: CalendarHeart,
    title: 'Flexible weekly payment terms',
    description: 'Manageable and affordable installment plans that align directly with your earning cycles.'
  },
  {
    icon: ShieldCheck,
    title: 'Full insurance coverage included',
    description: 'Drive with total peace of mind knowing you and your vehicle are fully covered under our plans.'
  },
  {
    icon: Signature,
    title: 'Path to asset ownership',
    description: 'Build equity with every single payment you make and eventually become an independent owner.'
  }
]
        ...
        <div className="relative z-10 w-full max-w-4xl bg-[#111827]/80 p-8 md:p-12 rounded-3xl backdrop-blur-md border border-white/10 shadow-2xl">
          <div className="text-center md:text-left mb-10 border-b border-white/10 pb-8">
            ...
            <p className="text-lg md:text-xl text-gray-300">
              Rent Today, Own Your EV Tomorrow
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            {FEATURES.map((feature, idx) => (
              <div key={idx} className="flex gap-4 items-start p-5 bg-white/5 rounded-2xl border border-white/5 hover:bg-white/10 transition-colors">
                <div className="bg-[#EC4899]/20 p-3 rounded-lg text-[#EC4899] shrink-0">
